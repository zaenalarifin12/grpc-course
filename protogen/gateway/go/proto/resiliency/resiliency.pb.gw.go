...
import (
	...
	extResiliency "github.com/zaenalarifin12/grpc-course/protogen/go/resiliency"
...
var (
	filter_ResiliencyService_StreamingResiliency_0 = &utilities.DoubleArray{Encoding: map[string]int{"min_delay_second": 0, "max_delay_second": 1}, Base: []int{1, 2, 4, 0, 0, 0, 0}, Check: []int{0, 1, 1, 2, 2, 3, 3}}
)

func request_ResiliencyService_StreamingResiliency_0(ctx context.Context, marshaler runtime.Marshaler, client extResiliency.ResiliencyServiceClient, req *http.Request, pathParams map[string]string) (extResiliency.ResiliencyService_StreamingResiliencyClient, runtime.ServerMetadata, error) {
	var protoReq extResiliency.ResiliencyRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ResiliencyService_StreamingResiliency_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	stream, err := client.StreamingResiliency(ctx, &protoReq)
	if err != nil {
...
func request_ResiliencyWithMetadataService_StreamingResiliencyWithMetadata_0(ctx context.Context, marshaler runtime.Marshaler, client extResiliency.ResiliencyWithMetadataServiceClient, req *http.Request, pathParams map[string]string) (extResiliency.ResiliencyWithMetadataService_StreamingResiliencyWithMetadataClient, runtime.ServerMetadata, error) {
	var protoReq extResiliency.ResiliencyRequest
	var metadata runtime.ServerMetadata
	...
	stream, err := client.StreamingResiliencyWithMetadata(ctx, &protoReq)
	if err != nil {
		return nil, metadata, err
	}
	header, err := stream.Header()
...
func RegisterResiliencyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extResiliency.ResiliencyServiceServer) error {
	...
	mux.Handle("GET", pattern_ResiliencyService_StreamingResiliency_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterResiliencyWithMetadataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extResiliency.ResiliencyWithMetadataServiceServer) error {
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_StreamingResiliencyWithMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		err := status.Error(codes.Unimplemented, "streaming calls are not yet supported in the in-process transport")
		_, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		return
...
func RegisterResiliencyServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extResiliency.ResiliencyServiceClient) error {
	...
	mux.Handle("GET", pattern_ResiliencyService_StreamingResiliency_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyService/StreamingResiliency", runtime.WithHTTPPathPattern("/api/resiliency/v1/server_streaming/{min_delay_second}/{max_delay_second}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResiliencyService_StreamingResiliency_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ResiliencyService_StreamingResiliency_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_ResiliencyService_StreamingResiliency_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"api", "resiliency", "v1", "server_streaming", "min_delay_second", "max_delay_second"}, ""))
...
var (
	...
	forward_ResiliencyService_StreamingResiliency_0 = runtime.ForwardResponseStream
...
func RegisterResiliencyWithMetadataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extResiliency.ResiliencyWithMetadataServiceClient) error {
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_StreamingResiliencyWithMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/StreamingResiliencyWithMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/metadata/server_streaming"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResiliencyWithMetadataService_StreamingResiliencyWithMetadata_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ResiliencyWithMetadataService_StreamingResiliencyWithMetadata_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_ResiliencyWithMetadataService_StreamingResiliencyWithMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "resiliency", "v1", "metadata", "server_streaming"}, ""))
...
var (
	...
	forward_ResiliencyWithMetadataService_StreamingResiliencyWithMetadata_0 = runtime.ForwardResponseStream
